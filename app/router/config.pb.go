...
var file_app_router_config_proto_rawDesc = []byte{
	...
	,
	...
	0x42, 0x6c, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x6d, 0x65, 0x73, 0x73, 0x6f, 0x63, 0x6b,
	0x65, 0x74, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x72, 0x6f, 0x75, 0x74,
	0x65, 0x72, 0x50, 0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x76, 0x6d, 0x65, 0x73, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x76, 0x6d, 0x65, 0x73,
	0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x65,
	0x72, 0xaa, 0x02, 0x1a, 0x76, 0x6d, 0x65, 0x73, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x43,
...
var file_app_router_config_proto_goTypes = []interface{}{
	...
	(*Domain)(nil),           // 1: vmessocket.core.app.router.Domain
	(*CIDR)(nil),             // 2: vmessocket.core.app.router.CIDR
	(*GeoIP)(nil),            // 3: vmessocket.core.app.router.GeoIP
	(*GeoIPList)(nil),        // 4: vmessocket.core.app.router.GeoIPList
	(*GeoSite)(nil),          // 5: vmessocket.core.app.router.GeoSite
	(*GeoSiteList)(nil),      // 6: vmessocket.core.app.router.GeoSiteList
	(*RoutingRule)(nil),      // 7: vmessocket.core.app.router.RoutingRule
	(*BalancingRule)(nil),    // 8: vmessocket.core.app.router.BalancingRule
	(*Config)(nil),           // 9: vmessocket.core.app.router.Config
	(*Domain_Attribute)(nil), // 10: vmessocket.core.app.router.Domain.Attribute
	(*net.PortRange)(nil),    // 11: vmessocket.core.common.net.PortRange
	(*net.PortList)(nil),     // 12: vmessocket.core.common.net.PortList
	(*net.NetworkList)(nil),  // 13: vmessocket.core.common.net.NetworkList
	(net.Network)(0),         // 14: vmessocket.core.common.net.Network
}
var file_app_router_config_proto_depIdxs = []int32{
	...
	10, // 1: vmessocket.core.app.router.Domain.attribute:type_name -> vmessocket.core.app.router.Domain.Attribute
	2,  // 2: vmessocket.core.app.router.GeoIP.cidr:type_name -> vmessocket.core.app.router.CIDR
	3,  // 3: vmessocket.core.app.router.GeoIPList.entry:type_name -> vmessocket.core.app.router.GeoIP
	1,  // 4: vmessocket.core.app.router.GeoSite.domain:type_name -> vmessocket.core.app.router.Domain
	5,  // 5: vmessocket.core.app.router.GeoSiteList.entry:type_name -> vmessocket.core.app.router.GeoSite
	1,  // 6: vmessocket.core.app.router.RoutingRule.domain:type_name -> vmessocket.core.app.router.Domain
	2,  // 7: vmessocket.core.app.router.RoutingRule.cidr:type_name -> vmessocket.core.app.router.CIDR
	3,  // 8: vmessocket.core.app.router.RoutingRule.geoip:type_name -> vmessocket.core.app.router.GeoIP
	11, // 9: vmessocket.core.app.router.RoutingRule.port_range:type_name -> vmessocket.core.common.net.PortRange
	12, // 10: vmessocket.core.app.router.RoutingRule.port_list:type_name -> vmessocket.core.common.net.PortList
	13, // 11: vmessocket.core.app.router.RoutingRule.network_list:type_name -> vmessocket.core.common.net.NetworkList
	14, // 12: vmessocket.core.app.router.RoutingRule.networks:type_name -> vmessocket.core.common.net.Network
	2,  // 13: vmessocket.core.app.router.RoutingRule.source_cidr:type_name -> vmessocket.core.app.router.CIDR
	3,  // 14: vmessocket.core.app.router.RoutingRule.source_geoip:type_name -> vmessocket.core.app.router.GeoIP
	12, // 15: vmessocket.core.app.router.RoutingRule.source_port_list:type_name -> vmessocket.core.common.net.PortList
	7,  // 16: vmessocket.core.app.router.Config.rule:type_name -> vmessocket.core.app.router.RoutingRule
	8,  // 17: vmessocket.core.app.router.Config.balancing_rule:type_name -> vmessocket.core.app.router.BalancingRule
