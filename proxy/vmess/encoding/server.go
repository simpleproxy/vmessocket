...
import (
	...
	"github.com/vmessocket/vmessocket/common/drain"
	...
	vmessaead "github.com/vmessocket/vmessocket/proxy/vmess/aead"
)
...
func (s *ServerSession) DecodeRequestHeader(reader io.Reader) (*protocol.RequestHeader, error) {
	...
	case errorAEAD == vmessaead.ErrNotFound:
		...
		if s.isAEADForced {
			return nil, drainConnection(newError("invalid user: VMessAEAD is enforced and a non VMessAEAD connection is received."))
		}
	...
	copy(s.requestBodyIV[:], buffer.BytesRange(1, 17))
	copy(s.requestBodyKey[:], buffer.BytesRange(17, 33))
	var sid sessionID
	...
	s.responseHeader = buffer.Byte(33)
	request.Option = bitmask.Byte(buffer.Byte(34))
