...
// Config is the master config of vmessocket. vmessocket takes this config as input and
...
type Config struct {
	...
	// App is for configurations of all features in vmessocket. A feature must
	...
	// extension is not loaded into vmessocket. vmessocket will ignore such config during
	// initialization.
